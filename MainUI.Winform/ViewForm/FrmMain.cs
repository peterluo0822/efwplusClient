...
namespace WinMainUIFrame.Winform.ViewForm
{
    public partial class FrmMain : Office2007Form, IfrmMain
    {
        ...
        private void AddToolMenu(BaseMenu menu)
        {
            if (menu.MenuToolBar == 1)
            {
                ...
                try
                {
                    ...
                    toolbarItem.Image = Image.FromFile(AppDomain.CurrentDomain.BaseDirectory + @"images\defaulttool.png");
                }
        ...
        private void defaultToolMenu()
        {
            ...
            toolbarItem1.Image = Image.FromFile(AppDomain.CurrentDomain.BaseDirectory + @"images\2.png");
            ...
            toolbarItem2.Image = Image.FromFile(AppDomain.CurrentDomain.BaseDirectory + @"images\3.png");
            ...
            toolbarItem3.Image = Image.FromFile(AppDomain.CurrentDomain.BaseDirectory + @"images\1.png");
            ...
            toolbarItem4.Image = Image.FromFile(AppDomain.CurrentDomain.BaseDirectory + @"images\4.png");
